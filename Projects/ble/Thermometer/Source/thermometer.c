 ...
 *                 HAL_KEY_SW_2
 *                 HAL_KEY_SW_1
 *°´¼üÒ»´Î»á½øÀ´Á½´Î£¬ÓÃÀ´È¡Ïû³¤°´ÊÂ¼þ¡£
¾ßÌåÔ­ÀíÊÇ£¬°´¼üÊÇÖÐ¶ÏµÄ£¬ÖÐ¶ÏÒ»´ÎºóÁ¢¼´¸ÄÎª100ms²éÑ¯£¬Èç¹û100ms²éÑ¯µ½Ã»ÓÐ±ä»¯£¬ÔòÊ²Ã´Ò²²»·¢Éú£¬¼ÌÐø100ms²éÑ¯¡£Èç¹û²éÑ¯µ½±ä»¯¾ÍÔÙ·¢³öÒ»´ÎÊÂ¼þ¡£
 * @return  none
 */
uint8 test = 0;
...
void ChangeValueToString(uint32 Data ,uint8 *Buff)//½«ÊýÖµ×ª»»Îª×Ö·û´®
{
...
static void thermometerImeasNotify(void)
{
  ...
  ////thermometerCelcius = (ADCL >> 4);  // ¼´Ê¹·Åµ½ÏÂ¸öÖÜÆÚ¶Á£¨¼´Ê¹µÈ´ýeoc£©£¬Ò²ÊÇ¸úÃ»ÓÐeocÊ±¾Í¶ÁµÄ½á¹ûÒ»Ñù¡£ÐèÒª¼ÌÐøÊÔÑé£¬Ä¿µÄÊÇÏû³ýwhile£¬²¢ÇÒÌá¸ß¾«¶È
  ////thermometerCelcius |= (ADCH << 4);
